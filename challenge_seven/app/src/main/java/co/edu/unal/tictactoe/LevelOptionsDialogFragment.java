...
public class LevelOptionsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        final String[] levels = getActivity().getResources().getStringArray(R.array.list_difficulty_level);
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setSingleChoiceItems(R.array.list_difficulty_level, -1, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(getActivity(), "Continue playing", Toast.LENGTH_SHORT).show();
            }
        });
